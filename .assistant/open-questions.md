...
**Linked:** D-009, D-010, D-012; `swarm-report/calendar-telemost-implementation-2026-06-20.md`
**Status:** open; decide before relying on logout for operational cleanup. **Update 2026-06-20 (D-010):** now a *third* un-cleared profile (`forms`) exists alongside `mail` and `calendar-telemost`; the gap widened. **Update 2026-07-10 (D-012):** fourth un-cleared profile `disk` added; profile-aware logout is now overdue.
...
**Linked:** D-012; `swarm-report/yandex-disk-support-plan-2026-07-10.md` (N-1, C-11)
...
**Linked:** D-012; `swarm-report/yandex-disk-support-plan-2026-07-10.md` (N-4)
