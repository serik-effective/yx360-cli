...
Output contract: strict YAML per `.claude/agents/<role>.md`. Refactor-specific fields each agent emits: `preserved_public_api: [...]`, `breaks_if: [...]`, `migration_steps: [...]`.
...
```
/refactor "split scraping-architect.md anti-bot section into per-vendor files" --scope .claude/agents
